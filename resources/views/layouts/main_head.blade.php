<section id="sidebarCollapse" class="side-menu">
    ...
    <div class="side-menu-widget about-widget"><a href="index.html" class="logo"><img src="images/icon/lr-home.png" alt="Awesome Image"></a>
  ...
  <nav id="main-navigation-wrapper" class="navbar navbar-default transBg-main-menu-header _fixed-header _light-header stricky">
    <div class="container">
      <div class="navbar-header">
        <button type="button" data-toggle="collapse" data-target="#main-navigation" aria-expanded="false" class="navbar-toggle collapsed"><span class="sr-only">Toggle navigation</span><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></button><a href="index.html" class="navbar-brand"><img alt="Awesome Image" src="images/header/logo.png" class="default-logo"><img src="images/header/logo2.png" alt="Awesome Logo" class="secondary-logo"></a>
      </div>
